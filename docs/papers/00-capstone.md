...
00 Capstone (PDF p. 18) · 00 Comprehensive Treatise (PDF p. 25) · 01 Foundations (PDF p. 70) · 02 Structure Spectral Theory (PDF p. 81) · 03 Causal Network Spectral Theory (PDF p. 91) · 04 Variational & Conservation (PDF p. 102) · 05 Graded Media Engineering (PDF p. 113) · 06 Power Networks & Synchronization (PDF p. 123) · 07 Epidemiology on Adaptive Networks (PDF p. 134) · 08 Numerical Methods (PDF p. 144) · 09 Higher-Dimensional Structure-Flow (PDF p. 155) · 10 Causal Graph-Time Signal Processing (PDF p. 167) · 11 Novelty, Literature & Research Program (PDF p. 177) · 12 Quantum & Information (PDF p. 189)