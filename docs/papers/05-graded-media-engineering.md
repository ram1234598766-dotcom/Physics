...
| Perturbation type | \(\|\delta\rho\|_\infty/\rho_0\) | \(\delta\Lambda/\Lambda\) | \(\delta\vertT\vert/\vertT\vert\) |
|---|---|---|---|
...
| Perturbation type | \(\|\delta\rho\|_\infty/\rho_0\) | \(\delta\Lambda/\Lambda\) | \(\delta\vertT\vert/\vertT\vert\) | \(\delta\omega_1/\omega_1\) |
|---|---|---|---|---|
