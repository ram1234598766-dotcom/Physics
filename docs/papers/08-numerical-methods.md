...
| Scheme | \(\Delta t\) | Drift \(\vertE^N-E^0\vert/E^0\) | Bound (19) |
|---|---|---|---|
...
|---|---|---|---|
| Leapfrog | Unit disk \(\vert\Delta t\cdot\omega\vert \le 2\) | \(\vert\Delta t\cdot\omega\vert=2\) | \(\vert\Delta t\cdot\omega\vert>2\) |
| Forward Euler | Unit interval \(-1 \le \Delta t\cdot\omega \le 1\) | \(\vert\Delta t\cdot\omega\vert=1\) | \(\vert\Delta t\cdot\omega\vert>1\) |
...
|---|---|---|---|---|
| Leapfrog | \(\vert\Delta t\omega\vert \le 2\) | 2 | Drift \(O((\Delta t)^2)\) | Yes |
