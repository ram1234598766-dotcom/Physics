...
8. **Paper 15** (PDF p. 8) presents Structural Synthesis Dynamics, a new theory built on four postulates. It can be read independently of the other papers, though Papers 01–02 provide the mathematical foundation.
...
**For the physical theory** (Structural Synthesis Dynamics):
1. Read Paper 15 (Structural Synthesis Dynamics) — no prior SFC background required for the physical ideas, though Papers 01–02 provide the mathematical foundation.
