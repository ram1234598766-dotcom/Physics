...
<header class="hero">
  ...
  <p>Complete documentation — the capstone, the treatise, the thirteen research papers, and the program reports, in one readable file.</p>
</header>
<div class="wrap">
  <nav class="toc-box">
    <h2>Contents</h2>
  ...
  ${bodyHtml}
  <footer>Mrityunjay K &mdash; generated by scripts/build-standalone.mjs</footer>
</div>
</body>
</html>
`
